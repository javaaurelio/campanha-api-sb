		...
		for (Voto itemVoto : allByPesquisaEventoIdAndDataVoto) {
			...
			listaAtividade.add(
					new DadosDashboardEventoPainelAtividadesOnlineVoto(itemVoto.getId(), itemVoto.getVoto(), 
							itemVoto.getPesquisa().getPesquisa(), itemVoto.getPesquisado().getNome(), itemVoto.getPesquisado().getCidade(), "", formatDuration.toString(), formatDurationEspecifico.toString(), 0));
		}
